    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'center', gap: '24px', height: '500px' }}>
        ...
        >
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            <p style={{ color: '#9a8b78', fontSize: '16px', fontStyle: 'italic', lineHeight: 1.65, fontFamily: 'Inter, sans-serif', margin: 0 }}>
              Alexander handled my criminal case with exceptional skill and composure. The charges were dropped — I can finally move forward with my life.
            </p>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <div style={{ color: '#303030', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>Henry Morrison</div>
            <div style={{ color: '#303030', fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>Business Owner, Morrison &amp; Sons Ltd.</div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ width: '49px', height: '49px', borderRadius: '50%', backgroundColor: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="27" height="27" viewBox="0 0 24 24" fill="none" stroke="#B8963E" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={{ position: 'relative', flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            <p style={{ color: '#FFFFFF', fontSize: '18px', fontStyle: 'italic', lineHeight: 1.65, fontFamily: 'Inter, sans-serif', margin: 0 }}>
              I was facing a complex property dispute with no clear resolution in sight. Alexander cut through the noise and secured exactly the outcome I needed.
            </p>
          </div>
          <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <div style={{ color: '#FFFFFF', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>Diana Laurent</div>
            <div style={{ color: '#FFFFFF', fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>Real Estate Investor</div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
            <p style={{ color: '#9a8b78', fontSize: '16px', fontStyle: 'italic', lineHeight: 1.65, fontFamily: 'Inter, sans-serif', margin: 0 }}>
              Going through a divorce is incredibly difficult. Alexander made the legal side manageable and always kept my children&apos;s welfare at the centre.
            </p>
          </div>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '4px' }}>
            <div style={{ color: '#303030', fontSize: '14px', fontFamily: 'Inter, sans-serif', fontWeight: 600 }}>Martha Reynolds</div>
            <div style={{ color: '#303030', fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>Primary School Teacher</div>
          </div>
        </motion.div>
